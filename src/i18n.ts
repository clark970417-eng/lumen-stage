...
const DICT = {
  ...
  'tour.desktop.1.title': { en: 'Four modes, one continuous scene', zh: '四個模式，共用同一個場景', ja: '4 つのモード、1 つのシーン' },
  'tour.desktop.1.body': { en: 'Use Person, Light, Camera and Layout from left to right. Switching modes changes the controls—not the scene you have already built.', zh: '依序使用「人物、佈光、相機、配置」。切換模式只會換控制內容，不會重置已經建立的場景。', ja: '人物、照明、カメラ、配置の順に使います。モードを変えても、作成したシーンは維持されます。' },
  'tour.desktop.2.title': { en: 'Start with the subject and stage', zh: '先決定人物與舞台內容', ja: '人物と舞台から始める' },
  'tour.desktop.2.body': { en: 'Choose the subject, height, vertical position and pose on the right. Add people, products, furniture or backdrops from Add to stage on the left.', zh: '右側調整人物、身高、垂直位置與姿勢；左下「加入舞台」可新增人物、商品、家具或背景。', ja: '右側で人物、身長、高さ位置、ポーズを調整。左下の「ステージに追加」から人物、商品、家具、背景を追加します。' },
  'tour.desktop.3.title': { en: 'Shape one light at a time', zh: '一次調整一盞燈', ja: 'ライトを 1 灯ずつ整える' },
  'tour.desktop.3.body': { en: 'Select a light, then tune output, distance, angle, colour and modifier. Use the centre tools to move, rotate or aim it directly in the scene.', zh: '先選燈具，再調整功率、距離、角度、色溫與塑光附件；中央工具可直接移動、旋轉或瞄準。', ja: 'ライトを選び、出力、距離、角度、色、モディファイアを調整。中央ツールで移動、回転、照射できます。' },
  'tour.desktop.4.title': { en: 'Frame with the actual camera controls', zh: '用實際相機控制完成取景', ja: '実際のカメラ設定で構図を決める' },
  'tour.desktop.4.body': { en: 'Set focal length, aperture, shutter, ISO and focus, then use Viewfinder to check the final crop instead of judging from the shelf view.', zh: '設定焦段、光圈、快門、ISO 與對焦，再切到「鏡頭畫面」確認最終裁切，不必只靠棚內視角判斷。', ja: '焦点距離、絞り、シャッター、ISO、フォーカスを設定し、ファインダーで最終クロップを確認します。' },
  'tour.desktop.5.title': { en: 'Compare, reset and save what works', zh: '比較、重設，再把有效設定存下來', ja: '比較・リセット・プリセット保存' },
  'tour.desktop.5.body': { en: 'Each major section can compare before and after or reset independently. The fixed footer resets everything, opens presets or saves the current setup; project backup and export stay in More.', zh: '每個主要設定都能獨立查看前後差異或重設。右下固定列可重設全部、開啟預設或儲存目前設定；專案備份與匯出則在「更多」。', ja: '各セクションで前後比較と個別リセットが可能。右下の固定バーで全体リセット、プリセット表示、現在設定の保存を行い、バックアップと書き出しは「その他」にあります。' },
  ...
  'tour.mobile.1.title': { en: 'Person: keep only the essential controls', zh: '人物：只保留重要設定', ja: '人物：必要な設定だけ' },
  'tour.mobile.1.body': { en: 'Choose the body type, height, vertical position, age, pose and appearance. The phone view keeps these decisions together and skips desktop-only drawers.', zh: '可調整骨架、身高、垂直位置、年齡、姿勢與外觀；手機版把必要決策集中在一起，不顯示桌機才需要的抽屜。', ja: '体格、身長、高さ位置、年齢、ポーズ、外観を調整。スマホでは必要な項目だけをまとめています。' },
  'tour.mobile.2.title': { en: 'Light: touch-friendly shaping', zh: '佈光：用觸控快速塑光', ja: '照明：タッチで素早く調整' },
  'tour.mobile.2.body': { en: 'Select a light and adjust output, distance, angle, colour and modifier with controls sized for touch.', zh: '選擇燈具後，用適合觸控的控制調整功率、距離、角度、色溫與塑光附件。', ja: 'ライトを選び、タッチしやすい操作で出力、距離、角度、色、モディファイアを調整します。' },
  'tour.mobile.3.title': { en: 'Camera: check the final crop', zh: '相機：確認最終裁切', ja: 'カメラ：最終クロップを確認' },
  'tour.mobile.3.body': { en: 'Set focal length, aperture, shutter and ISO, then switch between Lighting and Viewfinder above the scene.', zh: '設定焦段、光圈、快門與 ISO，再用場景上方的「佈光／鏡頭畫面」切換確認構圖。', ja: '焦点距離、絞り、シャッター、ISO を設定し、シーン上部で照明表示とファインダーを切り替えます。' },
  'tour.mobile.4.title': { en: 'Layout: move every object left or right', zh: '配置：左右移動所有物件', ja: '配置：すべてを左右に移動' },
  'tour.mobile.4.body': { en: 'Select any object, then adjust its horizontal position. The same scene remains available when you return to desktop.', zh: '選擇任一物件後調整左右位置；回到桌機時仍會接續同一個場景。', ja: '対象を選び、左右位置を調整。デスクトップへ戻っても同じシーンを続けられます。' },
  'tour.mobile.5.title': { en: 'Validation: continuity, backup and sharing', zh: '驗證：連戲、備份與分享', ja: '検証：連続性・保存・共有' },
  'tour.mobile.5.body': { en: 'Lock the baseline for continuity, then save locally, export a portable backup, import another project or copy a review link.', zh: '先建立基準以檢查光線連戲，再立即儲存、匯出可攜備份、匯入專案或複製分享連結。', ja: '連続性の基準を保存し、ローカル保存、バックアップ書き出し、読み込み、共有リンクのコピーを行います。' },
