...
const DICT = {
  ...
  'mobile.hint.layout': { en: 'Top view · drag the arrows to move', zh: '俯視配置 · 拖曳箭頭移動位置', ja: '俯視配置・矢印をドラッグして移動' },
  ...
  'mobile.layout.note': { en: 'Choose any item and adjust only its left or right position. Rotation and equipment settings stay locked.', zh: '選擇任一物件後，只調整左右位置；旋轉與器材設定會保持不變。', ja: '対象を選び、左右位置だけを調整します。回転と機材設定は固定されます。' },
  ...
  'tour.mobile.2.body': { en: 'Choose Loop or Rembrandt from the setup cards, then adjust one light if needed.', zh: '從預設卡選「環形光」或「林布蘭光」，需要時再微調一盞燈。', ja: 'ループかレンブラントを選び、必要ならライトを 1 灯だけ調整します。' },
