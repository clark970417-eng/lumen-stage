...
const DICT = {
  ...
  // ── 姿勢庫與關節 ────────────────────────────────────────
  'pose.retargeted': { en: 'RETARGETED SKELETON', zh: '已對應外部骨架', ja: 'リターゲット済み' },
  'pose.unrigged': { en: 'NO HUMANOID SKELETON', zh: '未偵測到人形骨架', ja: 'ヒューマノイド骨格なし' },
  'pose.retargetNote': { en: 'The imported skeleton was matched to this rig. Joints, hands and any blendshapes the file ships all respond.', zh: '已將匯入的骨架對應到本系統的骨架，關節、手勢與檔案內建的表情變形都可控制。', ja: '読み込んだ骨格をこのリグに対応させました。関節・手の形・ファイル内のブレンドシェイプが動きます。' },
  'pose.unriggedNote': { en: 'This file has no skeleton the rig recognises, so only height and facing apply. Mixamo, VRM and Ready Player Me exports retarget automatically.', zh: '這個檔案沒有可辨識的人形骨架，只能調整身高與朝向。Mixamo、VRM 與 Ready Player Me 匯出的模型可自動對應。', ja: 'このファイルには認識できる骨格がないため、身長と向きのみ調整できます。Mixamo・VRM・Ready Player Me の書き出しは自動対応します。' },
  'pose.library': { en: 'Pose library', zh: '姿勢庫', ja: 'ポーズライブラリ' },
  'pose.custom': { en: 'Custom', zh: '自訂', ja: 'カスタム' },
  'pose.category.standing': { en: 'Standing', zh: '站姿', ja: '立ち' },
  'pose.category.seated': { en: 'Seated', zh: '坐姿', ja: '座り' },
  'pose.category.dynamic': { en: 'Dynamic', zh: '動態', ja: 'ダイナミック' },
  'pose.category.beauty': { en: 'Beauty', zh: '美妝人像', ja: 'ビューティー' },
  ...
  'pose.group.hands': { en: 'Hands', zh: '手掌', ja: '手' },
  'pose.group.legs': { en: 'Legs', zh: '腿部', ja: '脚' },
  'pose.group.face': { en: 'Expression', zh: '表情', ja: '表情' },
  'pose.headRoll': { en: 'Head roll', zh: '頭部側傾', ja: '頭の傾き' },
  'pose.neckExtend': { en: 'Neck extension', zh: '頸部前伸', ja: '首の前出し' },
  'pose.spineBend': { en: 'Lean', zh: '前後傾', ja: '前後の傾き' },
  'pose.spineSide': { en: 'Side bend', zh: '側彎', ja: '横曲げ' },
  'pose.chestLift': { en: 'Chest lift', zh: '挺胸', ja: '胸の張り' },
  'pose.leftShoulder': { en: 'Left shoulder lift', zh: '左肩上提', ja: '左肩の上げ' },
  'pose.rightShoulder': { en: 'Right shoulder lift', zh: '右肩上提', ja: '右肩の上げ' },
  'pose.leftArmForward': { en: 'Left arm forward', zh: '左臂前擺', ja: '左腕の前振り' },
  'pose.rightArmForward': { en: 'Right arm forward', zh: '右臂前擺', ja: '右腕の前振り' },
  'pose.leftArmTwist': { en: 'Left arm rotation', zh: '左臂旋轉', ja: '左腕のひねり' },
  'pose.rightArmTwist': { en: 'Right arm rotation', zh: '右臂旋轉', ja: '右腕のひねり' },
  'pose.leftForearmTwist': { en: 'Left forearm twist', zh: '左前臂旋前', ja: '左前腕のひねり' },
  'pose.rightForearmTwist': { en: 'Right forearm twist', zh: '右前臂旋前', ja: '右前腕のひねり' },
  'pose.leftWrist': { en: 'Left wrist', zh: '左手腕', ja: '左手首' },
  'pose.rightWrist': { en: 'Right wrist', zh: '右手腕', ja: '右手首' },
  'pose.leftHand': { en: 'Left hand', zh: '左手勢', ja: '左手の形' },
  'pose.rightHand': { en: 'Right hand', zh: '右手勢', ja: '右手の形' },
  'pose.hipTilt': { en: 'Hip tilt', zh: '髖部傾斜', ja: '腰の傾き' },
  'pose.hipYaw': { en: 'Hip rotation', zh: '髖部旋轉', ja: '腰の回転' },
  'pose.stanceWidth': { en: 'Stance width', zh: '兩腳間距', ja: 'スタンス幅' },
  'pose.weightShift': { en: 'Weight on', zh: '重心', ja: '重心' },
  'pose.weight.left': { en: 'left foot', zh: '左腳', ja: '左足' },
  'pose.weight.right': { en: 'right foot', zh: '右腳', ja: '右足' },
  'pose.weight.even': { en: 'even', zh: '平均', ja: '均等' },
  'pose.leftLeg': { en: 'Left hip flexion', zh: '左髖前抬', ja: '左股関節の屈曲' },
  'pose.rightLeg': { en: 'Right hip flexion', zh: '右髖前抬', ja: '右股関節の屈曲' },
  'pose.leftLegSplay': { en: 'Left leg splay', zh: '左腿外展', ja: '左脚の開き' },
  'pose.rightLegSplay': { en: 'Right leg splay', zh: '右腿外展', ja: '右脚の開き' },
  'pose.leftKnee': { en: 'Left knee', zh: '左膝', ja: '左ひざ' },
  'pose.rightKnee': { en: 'Right knee', zh: '右膝', ja: '右ひざ' },
  'pose.leftAnkle': { en: 'Left ankle', zh: '左腳踝', ja: '左足首' },
  'pose.rightAnkle': { en: 'Right ankle', zh: '右腳踝', ja: '右足首' },
  'pose.leftFootTurn': { en: 'Left foot turn', zh: '左腳外八', ja: '左足の向き' },
  'pose.rightFootTurn': { en: 'Right foot turn', zh: '右腳外八', ja: '右足の向き' },
  'pose.browRaise': { en: 'Brow', zh: '眉毛', ja: '眉' },
  'pose.eyeOpen': { en: 'Eye aperture', zh: '眼睛張開', ja: '目の開き' },
  'pose.squint': { en: 'Squint', zh: '瞇眼', ja: '目を細める' },
  'pose.smile': { en: 'Smile', zh: '微笑', ja: '笑顔' },
  'pose.mouthOpen': { en: 'Mouth open', zh: '張嘴', ja: '口の開き' },
  'pose.lipPart': { en: 'Lips parted', zh: '雙唇微啟', ja: '唇の開き' },
  'pose.jawSet': { en: 'Jaw set', zh: '下顎前推', ja: 'あごの張り' },
  'pose.gazeYaw': { en: 'Gaze left / right', zh: '視線左右', ja: '視線の左右' },
  'pose.gazePitch': { en: 'Gaze up / down', zh: '視線上下', ja: '視線の上下' },
  'pose.mirror': { en: 'Mirror pose', zh: '左右鏡射', ja: 'ポーズを反転' },
  'pose.reset': { en: 'Reset pose', zh: '重設姿勢', ja: 'ポーズをリセット' },

  // ── 體型 ────────────────────────────────────────────────
  'physique.title': { en: 'Physique', zh: '體型', ja: '体型' },
  'physique.sub': { en: 'PARAMETRIC BODY', zh: '參數化人體', ja: 'パラメトリック' },
  'physique.sex': { en: 'Frame', zh: '骨架', ja: '骨格' },
  'physique.feminine': { en: 'Feminine', zh: '女性', ja: '女性的' },
  'physique.masculine': { en: 'Masculine', zh: '男性', ja: '男性的' },
  ...
  'physique.muscle': { en: 'Muscle', zh: '肌肉量', ja: '筋肉量' },
  'physique.shoulders': { en: 'Shoulder width', zh: '肩寬', ja: '肩幅' },
  'physique.waist': { en: 'Waist', zh: '腰圍', ja: 'ウエスト' },
  'physique.hips': { en: 'Hips', zh: '臀圍', ja: 'ヒップ' },
  'physique.bust': { en: 'Bust', zh: '胸圍', ja: 'バスト' },
  ...
  // ── 背景 ────────────────────────────────────────────────
  'backdrop.title': { en: 'Backdrop', zh: '背景', ja: '背景' },
  'backdrop.sub': { en: 'SEAMLESS / CANVAS / WALL', zh: '背景紙 / 畫布 / 牆面', ja: '背景紙 / キャンバス / 壁' },
  'backdrop.family.paper': { en: 'Seamless paper', zh: '無縫背景紙', ja: '背景紙' },
  'backdrop.family.canvas': { en: 'Painted canvas', zh: '手繪畫布', ja: '手描きキャンバス' },
  'backdrop.family.vinyl': { en: 'Vinyl', zh: 'PVC 背景', ja: 'ビニール' },
  'backdrop.family.wall': { en: 'Built wall', zh: '實體牆面', ja: '壁' },
  'backdrop.family.none': { en: 'None', zh: '不使用', ja: 'なし' },
  'backdrop.width': { en: 'Roll width', zh: '背景寬度', ja: '背景の幅' },
  'backdrop.distance': { en: 'Behind subject', zh: '離人物距離', ja: '被写体からの距離' },
  'backdrop.reflectance': { en: 'Reflectance', zh: '反射率', ja: '反射率' },
  'backdrop.fall': { en: 'Background falls', zh: '背景下降', ja: '背景の落ち込み' },
  'backdrop.stops': { en: '{value} stops under the face', zh: '比臉部低 {value} 級', ja: '顔より {value} 段暗い' },


  // ── 色片 ────────────────────────────────────────────────
  'gel.title': { en: 'Gel', zh: '色片', ja: 'ジェル' },
  'gel.sub': { en: 'FILTER IN THE PATH', zh: '光路上的濾片', ja: '光路上のフィルター' },
  'gel.category.correction': { en: 'CTO / CTB', zh: '色溫校正', ja: '色温度補正' },
  'gel.category.minus-green': { en: 'Green', zh: '綠色校正', ja: 'グリーン補正' },
  'gel.category.diffusion': { en: 'Diffusion', zh: '柔光片', ja: 'ディフュージョン' },
  'gel.category.nd': { en: 'ND', zh: '減光', ja: 'ND' },
  'gel.category.effect': { en: 'Colour', zh: '色彩', ja: 'カラー' },
  'gel.none': { en: 'No gel', zh: '不加色片', ja: 'ジェルなし' },
  'gel.loss': { en: 'Costs {value} stops', zh: '損失 {value} 級', ja: '{value} 段の損失' },
  'gel.shift': { en: 'Source now {value} K', zh: '色溫變為 {value} K', ja: '光源は {value} K に' },


  // ── 燈位預設庫 ──────────────────────────────────────────
  'msg.panel.setups': { en: 'Setup library {state}', zh: '燈位庫{state}', ja: 'ライティング集{state}' },
  'msg.setups.closed': { en: 'Setup library closed', zh: '已關閉燈位庫', ja: 'ライティング集を閉じました' },
  'setups.launcher': { en: 'Setups', zh: '燈位庫', ja: 'ライティング集' },
  'setups.launcher.title': { en: 'Lighting setup library (L)', zh: '燈位預設庫（L）', ja: 'ライティングプリセット（L）' },
  'setups.title': { en: 'Lighting setup library', zh: '燈位預設庫', ja: 'ライティングプリセット' },
  'setups.close': { en: 'Close the setup library', zh: '關閉燈位庫', ja: 'ライティング集を閉じる' },
  'setups.count': { en: '{count} classic setups', zh: '{count} 組經典燈位', ja: '{count} 件の定番セットアップ' },
  'setups.apply': { en: 'Apply setup', zh: '套用燈位', ja: 'セットアップを適用' },
  'setups.applied': { en: 'Applied · {name}', zh: '已套用 · {name}', ja: '適用済み · {name}' },
  'setups.replaceWarning': { en: 'Replaces every light, the camera and the backdrop. Undo with ⌘Z.', zh: '會替換所有燈具、相機與背景。可用 ⌘Z 復原。', ja: 'すべてのライト・カメラ・背景を置き換えます。⌘Z で戻せます。' },
  'setups.ratio': { en: 'Ratio', zh: '光比', ja: '光比' },
  'setups.lights': { en: 'Lights', zh: '燈具數', ja: 'ライト数' },
  'setups.category.portrait': { en: 'Portrait', zh: '人像', ja: 'ポートレート' },
  'setups.category.beauty': { en: 'Beauty', zh: '美妝', ja: 'ビューティー' },
  'setups.category.dramatic': { en: 'Dramatic', zh: '戲劇', ja: 'ドラマチック' },
  'setups.category.commercial': { en: 'Commercial', zh: '商業', ja: 'コマーシャル' },
  'setups.category.cinematic': { en: 'Cinematic', zh: '電影感', ja: 'シネマ' },


  // ── A/B 比對 ────────────────────────────────────────────
  'compare.title': { en: 'Compare', zh: '比對', ja: '比較' },
  'compare.pick': { en: 'Compare', zh: '加入比對', ja: '比較に追加' },
  'compare.clear': { en: 'Clear comparison', zh: '清除比對', ja: '比較を解除' },
  'compare.close': { en: 'Close the comparison', zh: '關閉比對', ja: '比較を閉じる' },
  'compare.hint': { en: 'Pick a second shot to compare against', zh: '再選一張照片進行比對', ja: 'もう一枚選んで比較します' },
  'compare.mode.slider': { en: 'Wipe', zh: '滑桿', ja: 'ワイプ' },
  'compare.mode.side': { en: 'Side by side', zh: '並排', ja: '並べる' },
  'compare.a': { en: 'A', zh: 'A', ja: 'A' },
  'compare.b': { en: 'B', zh: 'B', ja: 'B' },
  'compare.diffLights': { en: '{value} lights', zh: '{value} 盞燈', ja: 'ライト {value} 灯' },
  ...
  'file.share': { en: 'Copy share link', zh: '複製分享連結', ja: '共有リンクをコピー' },
  'file.share.sub': { en: 'Whole scene in a URL', zh: '整個場景包在網址裡', ja: 'シーン全体を URL に' },
  'file.share.copied': { en: 'Copied', zh: '已複製', ja: 'コピーしました' },
  'file.share.error': { en: 'Copy failed', zh: '複製失敗', ja: 'コピーに失敗' },
  'msg.share.loaded': { en: 'Scene loaded from link', zh: '已從連結載入場景', ja: 'リンクからシーンを読み込みました' },
  'file.load': { en: 'Load local save', zh: '載入本機存檔', ja: 'ローカル保存を読み込む' },
  'file.load.sub': { en: 'Last saved', zh: '上次儲存', ja: '前回の保存' },

  // ── 作者、版權與資料 ────────────────────────────────────
  'about.open': { en: 'About & copyright', zh: '關於與版權', ja: '情報・著作権' },
  ...
  'scene.pose': { en: 'Pose', zh: '擺姿', ja: 'ポーズ' },
  'scene.pose.title': { en: 'Drag the joints to pose the figure (H)', zh: '直接拖曳關節擺姿勢（H）', ja: '関節をドラッグしてポーズ（H）' },
  'scene.pose.disabled': { en: 'Select a person to pose them', zh: '先選取人物才能擺姿勢', ja: '人物を選択するとポーズできます' },
  'msg.pose': { en: 'Pose handles {state}', zh: '擺姿把手{state}', ja: 'ポーズハンドル{state}' },
  'sc.pose': { en: 'Drag-to-pose handles', zh: '拖曳擺姿把手', ja: 'ポーズハンドル' },
  'scene.snap': { en: 'Snap', zh: '吸附', ja: 'スナップ' },
  'scene.snap.title': { en: 'Snap lights to 15° / 25 cm around the subject (⇧S)', zh: '燈具以人物為中心吸附 15° / 25 cm（⇧S）', ja: '被写体を中心に 15° / 25 cm でスナップ（⇧S）' },
  'msg.snap': { en: 'Placement snap {state}', zh: '位置吸附{state}', ja: '配置スナップ{state}' },
  'sc.snap': { en: 'Placement snapping', zh: '位置吸附', ja: '配置スナップ' },
  'scene.measure': { en: 'Measure', zh: '量測', ja: '計測' },
  'scene.measure.title': { en: 'Measure a distance (N)', zh: '量測距離（N）', ja: '距離を計測（N）' },
  'msg.measure': { en: 'Measure {state}', zh: '量測{state}', ja: '計測{state}' },
  'sc.measure': { en: 'Measure distance', zh: '量測距離', ja: '距離を計測' },
 ...
 * Catalogue labels.
 *
 * Gear, poses and backdrops carry their own English names in their catalogue
 * files; this only holds the translations, keyed by catalogue id. Anything
 * missing falls back to the English the catalogue already ships, so a new entry
 * is never a build error — it just reads in English until someone translates it.
 */
const CATALOG: Record<string, { zh: string; ja: string }> = {
  // Poses
  'pose.neutral': { zh: '中性站姿', ja: 'ニュートラル' },
  'pose.contrapposto': { zh: '重心偏移', ja: 'コントラポスト' },
  'pose.hands-on-hips': { zh: '叉腰', ja: '腰に手' },
  'pose.profile': { zh: '側身', ja: '横向き' },
  'pose.three-quarter': { zh: '四分之三側身', ja: '斜め45度' },
  'pose.arms-crossed': { zh: '雙手抱胸', ja: '腕組み' },
  'pose.hands-pockets': { zh: '手插口袋', ja: 'ポケットに手' },
  'pose.lean-back': { zh: '後仰', ja: '後ろへ反る' },
  'pose.walking': { zh: '行走', ja: '歩き' },
  'pose.seated-upright': { zh: '端坐', ja: '正しく座る' },
  'pose.seated-lean': { zh: '坐姿前傾', ja: '前かがみで座る' },
  'pose.seated-crossed': { zh: '翹腳坐', ja: '足を組んで座る' },
  'pose.seated-backward': { zh: '反坐椅子', ja: '椅子に跨る' },
  'pose.jump': { zh: '躍起', ja: 'ジャンプ' },
  'pose.reach': { zh: '向上伸展', ja: '上へ伸ばす' },
  'pose.twist': { zh: '軀幹扭轉', ja: '体をひねる' },
  'pose.crouch': { zh: '蹲姿', ja: 'しゃがみ' },
  'pose.beauty-front': { zh: '正面美妝', ja: 'ビューティー正面' },
  'pose.beauty-hands-face': { zh: '手托臉', ja: '顔に手' },
  'pose.over-shoulder': { zh: '回眸', ja: '振り返り' },
  'pose.chin-down': { zh: '低頭抬眼', ja: 'あご引き上目' },
  'pose.laughing': { zh: '大笑', ja: '笑い' },
  'pose.editorial': { zh: '時尚', ja: 'エディトリアル' },
  'pose.presenting': { zh: '展示手勢', ja: '提示' },
  'pose.holding': { zh: '手持商品', ja: '商品を持つ' },
  'pose.thinking': { zh: '手托下巴', ja: '考えるポーズ' },
  'pose.greeting': { zh: '揮手', ja: '手を振る' },
  // Hand poses
  'hand.relaxed': { zh: '自然放鬆', ja: '自然' },
  'hand.open': { zh: '張開', ja: '開く' },
  'hand.fist': { zh: '握拳', ja: '握りこぶし' },
  'hand.point': { zh: '指向', ja: '指さし' },
  'hand.pocket': { zh: '插口袋', ja: 'ポケット' },
  'hand.grip': { zh: '抓握', ja: '掴む' },
  // Physique presets
  'physique.slim': { zh: '纖細', ja: 'スリム' },
  'physique.editorial': { zh: '模特兒', ja: 'モデル体型' },
  'physique.average': { zh: '一般', ja: '標準' },
  'physique.curvy': { zh: '豐腴', ja: 'グラマー' },
  'physique.athletic': { zh: '健壯（男）', ja: 'アスリート（男）' },
  'physique.athletic-f': { zh: '健壯（女）', ja: 'アスリート（女）' },
  'physique.lean': { zh: '精瘦', ja: '細身' },
  'physique.heavy': { zh: '厚實', ja: 'がっしり' },
  'physique.neutral': { zh: '中性', ja: '中性' },
  // Hair
  'hair.short': { zh: '短髮', ja: 'ショート' },
  'hair.buzz': { zh: '平頭', ja: 'ベリーショート' },
  'hair.bob': { zh: '鮑伯頭', ja: 'ボブ' },
  'hair.long': { zh: '長髮', ja: 'ロング' },
  'hair.ponytail': { zh: '馬尾', ja: 'ポニーテール' },
  'hair.bun': { zh: '包頭', ja: 'お団子' },
  'hair.curly': { zh: '捲髮', ja: 'カール' },
  'hair.afro': { zh: '爆炸頭', ja: 'アフロ' },
  'hair.bald': { zh: '光頭', ja: 'スキンヘッド' },
  // Outfits
  'outfit.tshirt': { zh: 'T 恤', ja: 'Tシャツ' },
  'outfit.tank': { zh: '背心', ja: 'タンクトップ' },
  'outfit.shirt': { zh: '襯衫', ja: 'シャツ' },
  'outfit.suit': { zh: '西裝', ja: 'スーツ' },
  'outfit.coat': { zh: '長大衣', ja: 'ロングコート' },
  'outfit.dress': { zh: '洋裝', ja: 'ワンピース' },
  'outfit.gown': { zh: '禮服', ja: 'ドレス' },
  'outfit.activewear': { zh: '運動服', ja: 'スポーツウェア' },
  // Fabrics
  'fabric.cotton': { zh: '棉', ja: 'コットン' },
  'fabric.linen': { zh: '亞麻', ja: 'リネン' },
  'fabric.wool': { zh: '羊毛', ja: 'ウール' },
  'fabric.denim': { zh: '丹寧', ja: 'デニム' },
  'fabric.silk': { zh: '絲綢', ja: 'シルク' },
  'fabric.satin': { zh: '緞面', ja: 'サテン' },
  'fabric.leather': { zh: '皮革', ja: 'レザー' },
  'fabric.velvet': { zh: '絲絨', ja: 'ベルベット' },
  // Lighting setups
  'setup.rembrandt': { zh: '林布蘭光', ja: 'レンブラント' },
  'setup.loop': { zh: '環形光', ja: 'ループライト' },
  'setup.butterfly': { zh: '蝴蝶光 / 派拉蒙光', ja: 'バタフライ' },
  'setup.clamshell': { zh: '蚌殼光', ja: 'クラムシェル' },
  'setup.split': { zh: '分割光', ja: 'スプリット' },
  'setup.noir': { zh: '黑色電影', ja: 'フィルムノワール' },
  'setup.rim-pair': { zh: '雙側逆光', ja: 'ツインリム' },
  'setup.high-key': { zh: '高調', ja: 'ハイキー' },
  'setup.low-key': { zh: '低調', ja: 'ローキー' },
  'setup.three-point': { zh: '三點打光', ja: '三点照明' },
  'setup.window-light': { zh: '窗光', ja: '窓明かり' },
  'setup.gel-duo': { zh: '青橙對比', ja: 'ティール＆オレンジ' },
  'setup.product-tent': { zh: '商品頂光', ja: '商品トップライト' },
  'setup.short-broad': { zh: '短光位', ja: 'ショートライト' },
  'setup.fashion-hard': { zh: '硬光時尚', ja: 'ハードファッション' },
  // Backdrops
  'backdrop.super-white': { zh: '純白', ja: 'スーパーホワイト' },
  'backdrop.fashion-grey': { zh: '淺灰', ja: 'ファッショングレー' },
  'backdrop.studio-grey': { zh: '棚拍中灰', ja: 'スタジオグレー' },
  'backdrop.thunder-grey': { zh: '18% 中灰', ja: 'サンダーグレー' },
  'backdrop.charcoal': { zh: '炭灰', ja: 'チャコール' },
  'backdrop.black-paper': { zh: '黑色', ja: 'ブラック' },
  'backdrop.bone': { zh: '米白', ja: 'ボーン' },
  'backdrop.sand': { zh: '沙色', ja: 'サンド' },
  'backdrop.blush': { zh: '珊瑚粉', ja: 'コーラル' },
  'backdrop.crimson': { zh: '暗紅', ja: 'クリムゾン' },
  'backdrop.cobalt': { zh: '鈷藍', ja: 'コバルト' },
  'backdrop.forest': { zh: '墨綠', ja: 'フォレスト' },
  'backdrop.chroma-green': { zh: '綠幕', ja: 'グリーンバック' },
  'backdrop.chroma-blue': { zh: '藍幕', ja: 'ブルーバック' },
  'backdrop.canvas-grey': { zh: '灰調畫布', ja: 'グレーのキャンバス' },
  'backdrop.canvas-umber': { zh: '赭色畫布', ja: 'アンバーのキャンバス' },
  'backdrop.canvas-slate': { zh: '石板色畫布', ja: 'スレートのキャンバス' },
  'backdrop.vinyl-white': { zh: '白色 PVC', ja: '白ビニール' },
  'backdrop.vinyl-black': { zh: '黑色 PVC', ja: '黒ビニール' },
  'backdrop.cyc-white': { zh: '白色無縫棚', ja: 'ホリゾント（白）' },
  'backdrop.plaster-grey': { zh: '灰泥牆', ja: 'グレーの塗り壁' },
  'backdrop.concrete': { zh: '清水模', ja: 'コンクリート' },
  'backdrop.brick': { zh: '磚牆', ja: 'レンガ' },
  'backdrop.wood-panel': { zh: '木牆板', ja: '木の壁' },
  'backdrop.none': { zh: '無背景', ja: '背景なし' },
}

/**
 * Translates a catalogue entry by id, falling back to the catalogue's own text.
 */
export function useCatalogT() {
  const locale = useLocaleStore((state) => state.locale)
  return (id: string, fallback: string) => {
    if (locale === 'en') return fallback
    return CATALOG[id]?.[locale] ?? fallback
  }
}
