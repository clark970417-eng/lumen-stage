...
const DICT = {
  ...
  'mobile.layout.note': { en: 'Choose an item, then drag its arrows in the bright top view. Rotation and equipment settings stay locked.', zh: '先選物件，再於明亮俯視畫面拖曳箭頭；此模式只改位置，不會改旋轉或器材設定。', ja: '対象を選び、明るい俯視画面で矢印をドラッグします。回転と機材設定は固定されます。' },
  ...
  'mobile.subject.hint': { en: 'The essentials only: silhouette, vertical position, height, age, pose and clothing.', zh: '只保留影響構圖與打光的重要設定：骨架、Y 軸位置、身高、年齡、體態、動作與服裝。', ja: '構図と光に重要な骨格・Y 軸位置・身長・年齢・体型・ポーズ・衣装だけを表示します。' },
  ...
  'tour.desktop.3.body': { en: 'Select an object first, then use Move (G), Aim (T) or Rotate (R). The active tool tells you exactly what the next drag changes.', zh: '先選取物件，再使用「移動 G、瞄準 T、旋轉 R」。亮起的工具代表下一次拖曳會改變的內容。', ja: '先に対象を選び、移動 G、照射 T、回転 R を使います。点灯中のツールが次のドラッグ操作を示します。' },
  'tour.desktop.4.title': { en: 'Right: make the current decision', zh: '右側：完成目前決策', ja: '右側：現在の判断を仕上げる' },
  'tour.desktop.4.body': { en: 'Start with the visible creative choices, then open Advanced equipment parameters only when you need exact power, modifier, position, target or camera values.', zh: '先用上方效果選項決定方向；需要精確功率、塑光、位置、照射目標或相機數值時，再展開進階器材參數。', ja: 'まず上部の効果を選び、出力、モディファイア、位置、照射先、カメラ数値が必要な時だけ詳細設定を開きます。' },
  'tour.desktop.5.title': { en: 'Measure exposure instead of guessing', zh: '測光：用數據找出曝光問題', ja: '測光：数値で露出の問題を見つける' },
  'tour.desktop.5.body': { en: 'Open Exposure Analysis for average brightness, exposure offset, histogram, false colour and clipping. The image above is the real panel opened over this scene.', zh: '開啟測光分析即可查看平均亮度、曝光偏移、直方圖、假色與剪裁警示；上方就是在目前場景打開後的真實畫面。', ja: '露出分析で平均輝度、露出差、ヒストグラム、フォルスカラー、白飛びを確認できます。上は実際に開いた画面です。' },
  ...
  'tour.mobile.1.title': { en: 'Intent: start from a reference', zh: '定調：從參考照開始', ja: '方向：参考から始める' },
  'tour.mobile.1.body': { en: 'Import a local reference for a brightness estimate, or tap a lighting pattern to place its lights, camera and backdrop.', zh: '可匯入本機參考照取得明暗推測，或點選經典光型，一次放好燈具、相機與背景。', ja: '端末の参考画像から明暗を推定するか、定番の光型を選んでライト、カメラ、背景をまとめて配置します。' },
  'tour.mobile.2.title': { en: 'Blocking: pose and appearance', zh: '走位：調整姿勢與外觀', ja: '配置：ポーズと外観' },
  'tour.mobile.2.body': { en: 'Choose the subject, height, pose and appearance without opening the full desktop inspector.', zh: '直接在手機調整人物、身高、姿勢與外觀，不必打開桌面版完整控制面板。', ja: 'デスクトップの詳細パネルを開かず、人物、身長、ポーズ、外観を調整できます。' },
  'tour.mobile.3.title': { en: 'Lighting: tune one light at a time', zh: '塑光：逐盞調整燈具', ja: '光作り：1 灯ずつ調整' },
  'tour.mobile.3.body': { en: 'Select Key, Fill or another light, then change brightness, angle, distance and colour using controls sized for touch.', zh: '選擇主燈、補光或其他燈具，再用適合觸控的滑桿調整亮度、角度、距離與顏色。', ja: 'キー、フィルなどを選び、タッチ操作向けのスライダーで明るさ、角度、距離、色を調整します。' },
  'tour.mobile.4.title': { en: 'Framing: set camera and exposure', zh: '取景：完成相機與曝光', ja: '構図：カメラと露出' },
  'tour.mobile.4.body': { en: 'Set focal length, aperture, shutter, ISO and framing, then switch to Viewfinder to see the exact crop.', zh: '設定焦段、光圈、快門、ISO 與比例，再切到「取景」確認相機實際裁切。', ja: '焦点距離、絞り、シャッター、ISO、比率を設定し、ファインダーで実際の切り取りを確認します。' },
