...
const DICT = {
  ...
  'pose.count': { en: '{count} poses', zh: '{count} 個姿勢', ja: '{count} ポーズ' },
  // ── 體型 ────────────────────────────────────────────────
  ...
  'guide.zoomIn': { en: 'Zoom in', zh: '放大', ja: '拡大' },
  'guide.fitWidth': { en: 'Fit width', zh: '符合寬度', ja: '幅に合わせる' },
  'guide.duration': { en: '10-minute quick start', zh: '10 分鐘快速上手', ja: '10 分クイックスタート' },
  ...
  'guide.pageNamed': { en: 'Page {n}: {title}', zh: '第 {n} 頁：{title}', ja: '{n} ページ：{title}' },
  'guide.languageNote': { en: 'LUMEN STAGE · ENGLISH GUIDE', zh: 'LUMEN STAGE · 繁體中文指南', ja: 'LUMEN STAGE · 日本語ガイド' },
  'guide.contents': { en: 'Guide chapters', zh: '教學章節', ja: 'ガイド目次' },
  'guide.progress': { en: 'Chapter {n} of {total}', zh: '第 {n} 章，共 {total} 章', ja: '{total} 章中 {n} 章' },
  'guide.keyboardHint': { en: 'Tip: use ← → to move between chapters', zh: '提示：可用 ← → 切換章節', ja: 'ヒント：← → で章を切り替え' },
  'guide.previous': { en: 'Previous', zh: '上一頁', ja: '前へ' },
  'guide.next': { en: 'Next', zh: '下一頁', ja: '次へ' },
  'guide.done': { en: 'Finish', zh: '完成', ja: '完了' },
  'guide.chapter.1': { en: 'Start here', zh: '從這裡開始', ja: 'ここから開始' },
  'guide.chapter.2': { en: 'Your first image', zh: '10 分鐘完成第一張', ja: '最初の一枚' },
  'guide.chapter.3': { en: 'Know the workspace', zh: '認識工作區', ja: 'ワークスペース' },
  'guide.chapter.4': { en: 'Build and move', zh: '建立與移動', ja: '配置と移動' },
  'guide.chapter.5': { en: 'Shape the light', zh: '塑造燈光', ja: '光を整える' },
  'guide.chapter.6': { en: 'Camera and framing', zh: '相機與構圖', ja: 'カメラと構図' },
  'guide.chapter.7': { en: 'Measure exposure', zh: '測光分析', ja: '露出を測る' },
  ...
  'object.dog': { en: 'Dog', zh: '狗狗', ja: '犬' },
  'object.cat': { en: 'Cat', zh: '貓咪', ja: '猫' },
  'object.product': { en: 'Product', zh: '商品', ja: '商品' },
  ...
  'inspector.search.placeholder': { en: 'Find a control…', zh: '搜尋色溫、肩寬、同步速度…', ja: '色温・肩幅・同調速度を検索…' },
  'inspector.search.count': { en: '{count} found', zh: '找到 {count} 項', ja: '{count} 件' },
  'inspector.search.none': { en: 'No match', zh: '找不到符合的控制', ja: '見つかりません' },
  'inspector.search.clear': { en: 'Clear control search', zh: '清除控制搜尋', ja: '検索をクリア' },
  ...
  'axis.x': { en: 'Horizontal position', zh: '水平位置', ja: '左右位置' },
  'axis.y': { en: 'Vertical position', zh: '垂直位置', ja: '高さ位置' },
  'axis.z': { en: 'Depth position', zh: '前後位置', ja: '前後位置' },
  'axis.rotY': { en: 'Facing direction', zh: '朝向', ja: '向き' },
  ...
  'beam.pan': { en: 'Head pan', zh: '燈頭水平角度', ja: 'ライト水平角度' },
  'beam.tilt': { en: 'Head tilt', zh: '燈頭俯仰角度', ja: 'ライト仰角' },
  'beam.targetX': { en: 'Target X', zh: '目標 X', ja: 'ターゲット X' },
  'beam.targetY': { en: 'Target height', zh: '目標高度', ja: 'ターゲット高さ' },
  ...
  'camera.x': { en: 'Camera horizontal position', zh: '相機水平位置', ja: 'カメラ左右位置' },
  'camera.y': { en: 'Camera height', zh: '相機高度', ja: 'カメラ高さ' },
  'camera.z': { en: 'Camera depth', zh: '相機前後位置', ja: 'カメラ前後位置' },
  'camera.aimPoint': { en: 'Aim point', zh: '瞄準點', ja: '注視点' },
  'camera.aimX': { en: 'Aim X', zh: '瞄準 X', ja: '注視点 X' },
  'camera.aimY': { en: 'Aim height', zh: '瞄準高度', ja: '注視点の高さ' },
  ...
  // ── 簡易版 ──────────────────────────────────────────────
  'mobile.aria': { en: 'Lumen Stage, simple edition', zh: 'Lumen Stage 簡易版', ja: 'Lumen Stage シンプル版' },
  'mobile.badge': { en: 'SIMPLE', zh: '簡易版', ja: 'シンプル' },
  ...
  'mobile.compact': { en: 'Simple edition', zh: '簡易版', ja: 'シンプル版' },
  'mobile.compact.title': { en: 'Switch to the simple interface', zh: '切換到簡易版介面', ja: 'シンプル版に切り替える' },
  ...
  'mobile.hint.layout': { en: 'Drag an item to move · pinch to zoom', zh: '直接拖曽物品移動 · 雙指縮放', ja: '対象を直接ドラッグ・ピンチでズーム' },
  'mobile.hint.camera': { en: 'What the camera sees', zh: '相機看到的畫面', ja: 'カメラが見ている画面' },
  'mobile.layout.title': { en: 'Move positions', zh: '調整全場位置', ja: '全体の位置を調整' },
  'mobile.layout.note': { en: 'Drag any unlocked item directly in the view to move it across the floor. Use the slider for fine adjustments.', zh: '在畫面上直接拖曳未鎖定的物品，調整左右與前後位置；下方滑桿可微調。', ja: '画面上のロックされていない対象を直接ドラッグして前後左右へ移動。スライダーで微調整できます。' },
  'mobile.layout.horizontal': { en: 'Left / right', zh: '左右位置', ja: '左右位置' },
  ...
  'mobile.subject.hint': { en: 'The essentials only: silhouette, vertical position, height, age, pose and clothing.', zh: '只保留影響構圖與打光的重要設定：骨架、垂直位置、身高、年齡、體態、動作與服裝。', ja: '構図と光に重要な骨格・高さ位置・身長・年齢・体型・ポーズ・衣装だけを表示します。' },
  ...
  'mobile.light.pick': { en: 'Light', zh: '選擇燈具', ja: 'ライト' },
  'mobile.light.add': { en: 'Add a light', zh: '新增燈具', ja: 'ライトを追加' },
  ...
  'mobile.light.angle.left': { en: 'left', zh: '左', ja: '左' },
  'mobile.light.angle.right': { en: 'right', zh: '右', ja: '右' },
  'mobile.light.height': { en: 'Height', zh: '燈高', ja: '高さ' },
  'mobile.light.distance': { en: 'Distance', zh: '距離', ja: '距離' },
  'mobile.light.direction': { en: 'Lamp head direction', zh: '燈頭方向', ja: 'ライトの向き' },
  'mobile.light.pan': { en: 'Horizontal angle', zh: '水平角度', ja: '水平角度' },
  'mobile.light.tilt': { en: 'Tilt angle', zh: '俯仰角度', ja: '仰角' },
  'mobile.light.tilt.down': { en: 'down', zh: '向下', ja: '下向き' },
  'mobile.light.tilt.up': { en: 'up', zh: '向上', ja: '上向き' },
  'mobile.light.tilt.level': { en: 'level', zh: '水平', ja: '水平' },
  'mobile.light.temperature': { en: 'Colour temperature', zh: '色溫', ja: '色温度' },
  'mobile.light.empty': { en: 'No lights yet — pick a setup first.', zh: '目前沒有燈具，先挑一組燈位。', ja: 'ライトがありません。まずセットアップを選んでください。' },
  'mobile.camera.lens': { en: 'Lens', zh: '鏡頭', ja: 'レンズ' },
  'mobile.camera.orbit': { en: 'Camera angle', zh: '相機角度', ja: 'カメラアングル' },
  'mobile.camera.backdrop': { en: 'Backdrop', zh: '背景', ja: '背景' },
  'mobile.camera.hq': { en: 'High-quality render', zh: '高畫質算圖', ja: '高画質レンダリング' },
  'mobile.camera.hq.stop': { en: 'Back to live preview', zh: '回到即時預覽', ja: 'ライブプレビューに戻る' },
  'mobile.camera.hq.note': { en: 'Slower on a phone. The longer it runs, the cleaner it gets.', zh: '手機上較慢，算越久畫面越乾淨。', ja: 'スマホでは時間がかかります。長く回すほど滑らかになります。' },
  'mobile.shutter': { en: 'Take the photo', zh: '拍照', ja: '撮影' },
  'mobile.photo.title': { en: 'Your photo', zh: '你的照片', ja: '撮れた写真' },
  ...
  'tour.compare': { en: 'Before and after', zh: '操作前後比較', ja: '操作前後の比較' },
  'tour.before': { en: 'BEFORE', zh: '操作前', ja: '操作前' },
  'tour.after': { en: 'AFTER', zh: '操作後', ja: '操作後' },
  ...
  'tour.taskTry': { en: 'Try this in the highlighted area. You can still continue at any time.', zh: '請在標示區域實際操作；也可以隨時繼續下一步。', ja: '強調表示された場所で試してください。いつでも次へ進めます。' },
  'tour.taskDone': { en: 'Done — the scene has recorded your change.', zh: '已完成，場景已記錄這次變更。', ja: '完了しました。変更はシーンに反映されています。' },
  'tour.desktop.1.title': { en: 'Task 1 · Choose a pose', zh: '任務 1 · 選一個姿勢', ja: 'タスク 1 · ポーズを選ぶ' },
  'tour.desktop.1.body': { en: 'Pick a pose from the right panel. Start with Neutral stand or Hands in pockets so the lighting remains easy to read.', zh: '在右側姿勢庫選一個姿勢。第一次可先用「中性站姿」或「雙手插袋」，光線會比較容易判讀。', ja: '右側のポーズから選択します。最初はニュートラル立ちかポケットに手を入れた姿勢がおすすめです。' },
  'tour.desktop.2.title': { en: 'Task 2 · Apply a lighting setup', zh: '任務 2 · 套用一組燈法', ja: 'タスク 2 · ライティングを適用' },
  'tour.desktop.2.body': { en: 'The setup library is open for you. Apply Loop for a bright, forgiving portrait; it replaces the lights, camera and backdrop together.', zh: '燈位預設庫已替你打開。建議先套用明亮、容錯高的「環形光」；燈具、相機與背景會一起更新。', ja: 'プリセットを開きました。明るく扱いやすいループを適用すると、ライト・カメラ・背景が一緒に更新されます。' },
  'tour.desktop.3.title': { en: 'Task 3 · Set the camera', zh: '任務 3 · 調整相機', ja: 'タスク 3 · カメラを整える' },
  'tour.desktop.3.body': { en: 'Choose a headshot, half-body or full-body frame, then change one exposure setting. The Viewfinder shows the photograph rather than the studio layout.', zh: '先選臉部近景、半身或全身構圖，再改一項曝光設定；用「取景」判斷照片，不要只看棚內配置。', ja: '顔・上半身・全身の構図を選び、露出を 1 項調整します。写真はファインダーで確認します。' },
  'tour.desktop.4.title': { en: 'Task 4 · Check the final image', zh: '任務 4 · 查看成像', ja: 'タスク 4 · 最終画像を確認' },
  'tour.desktop.4.body': { en: 'Select Render in the view controls. It keeps the same framing and progressively replaces the preview with a higher-quality image.', zh: '在檢視列選擇「成像」。構圖不會改變，畫面會從即時預覽逐步提升為高品質成像。', ja: '表示メニューでレンダーを選びます。同じ構図のまま高品質画像へ切り替わります。' },
  'tour.desktop.5.title': { en: 'Task 5 · Save the shot', zh: '任務 5 · 儲存鏡位', ja: 'タスク 5 · ショットを保存' },
  'tour.desktop.5.body': { en: 'Press + Shot to save the current frame with its camera, lighting and scene settings. This is the first repeatable result of the workflow.', zh: '按「＋ 鏡位」保存目前畫面及其相機、燈光與場景設定。這就是第一個可重現的拍攝結果。', ja: '「＋ ショット」で現在の画像とカメラ・照明・シーン設定を保存します。' },
  'tour.desktop.6.title': { en: 'Bottom: keep camera settings visible', zh: '下方：隨時確認相機與場景讀值', ja: '下部：カメラとシーンの数値を常時確認' },
  'tour.desktop.6.body': { en: 'Lens, aperture, shutter, ISO, key-light colour and scene EV stay visible while you work, so important exposure choices never disappear inside a panel.', zh: '焦段、光圈、快門、ISO、主燈色溫與 Scene EV 會一直顯示；調整時不必反覆打開面板找數值。', ja: '焦点距離、絞り、シャッター、ISO、キーライト色温度、Scene EV を常時確認できます。' },
  'tour.desktop.7.title': { en: 'Imaging: turn the preview into a final photo', zh: '成像：把即時預覽變成最終照片', ja: 'レンダー：ライブ表示を最終写真へ' },
  'tour.desktop.7.body': { en: 'Imaging switches the same camera framing from a fast preview to progressive path tracing. Compare the real matched before/after, then wait for noise to settle before export.', zh: '「成像」會在同一個相機構圖中，從快速預覽切換到漸進式光線追蹤；上方前後構圖一致，可直接比較，等雜訊穩定後再輸出。', ja: '同じカメラ構図のまま高速プレビューからパストレーシングへ切り替えます。ノイズが落ち着いてから書き出します。' },
  'tour.desktop.8.title': { en: 'Save, back up and hand off the result', zh: '右上：儲存、備份與交付', ja: '右上：保存・バックアップ・引き継ぎ' },
  'tour.desktop.8.body': { en: 'Save Scene keeps work in this browser. Export a project file before changing devices or handing work off, and use the setup sheet when the crew needs a printable lighting plan.', zh: '「儲存場景」保留在目前瀏覽器；換裝置或交接前請匯出專案檔，需要帶到片場時再輸出燈位工作表。', ja: '「シーンを保存」はこのブラウザに保存します。端末変更や引き継ぎ前にプロジェクトを書き出し、現場用にはライト図を使います。' },
  'tour.mobile.1.title': { en: 'Task 1 · Choose a pose', zh: '任務 1 · 選一個姿勢', ja: 'タスク 1 · ポーズを選ぶ' },
  'tour.mobile.1.body': { en: 'Choose a simple standing pose. You can refine body and appearance later.', zh: '先選一個簡單站姿；體型和外觀之後再慢慢調整。', ja: 'まずシンプルな立ちポーズを選びます。体型と外観は後で調整できます。' },
  'tour.mobile.2.title': { en: 'Task 2 · Apply a lighting setup', zh: '任務 2 · 套用燈法', ja: 'タスク 2 · 照明を適用' },
  'tour.mobile.2.body': { en: 'In Layout, choose a portrait setup card. It applies the lights, camera and backdrop; switch to Light to refine an individual lamp.', zh: '在「配置」點選一張人像燈法卡，套用燈具、相機與背景；再到「佈光」微調單盞燈。', ja: '「配置」でポートレートのプリセットを選び、ライト・カメラ・背景を適用。「照明」で個々のライトを調整できます。' },
  'tour.mobile.3.title': { en: 'Task 3 · Set the camera', zh: '任務 3 · 調整相機', ja: 'タスク 3 · カメラを整える' },
  'tour.mobile.3.body': { en: 'Choose the framing and change one exposure value, then check the crop in the camera view.', zh: '選擇構圖並改一項曝光數值，再切到鏡頭畫面確認裁切。', ja: '構図と露出を 1 項調整し、カメラ表示でクロップを確認します。' },
  'tour.mobile.4.title': { en: 'Task 4 · Check the final image', zh: '任務 4 · 查看成像', ja: 'タスク 4 · 最終画像を確認' },
  'tour.mobile.4.body': { en: 'Turn on high-quality render and wait until the image settles.', zh: '開啟高品質成像，等待畫面逐步穩定。', ja: '高品質レンダーをオンにして画像が安定するまで待ちます。' },
  'tour.mobile.5.title': { en: 'Task 5 · Take the photo', zh: '任務 5 · 儲存照片', ja: 'タスク 5 · 写真を保存' },
  'tour.mobile.5.body': { en: 'Press the shutter. The captured photo opens immediately and can be downloaded to your device.', zh: '按下快門，拍攝結果會立即打開，並可下載到裝置。', ja: 'シャッターを押すと写真が開き、端末へダウンロードできます。' },
...
const CATALOG: Record<string, { zh: string; ja: string }> = {
  ...
  // Cast
  'cast.female': { zh: '日常', ja: '普段着' },
  'cast.note.female': { zh: '基準體型。襯衫牛仔褲,沒有需要繞開的東西。', ja: '基準体型。シャツとジーンズ、光が避けるものは何もありません。' },
  'cast.female-adult-07': { zh: '日常、豐滿', ja: '普段着・ふくよか' },
  'cast.note.female-adult-07': { zh: '軀幹較寬,外套。除了罩袍以外最寬的女性輪廓。', ja: '胴が広くジャケット。ローブを除けば最も広い女性のシルエット。' },
  'cast.female-adult-08': { zh: '日常、纖細', ja: '普段着・細身' },
  'cast.note.female-adult-08': { zh: '腰身很窄,短邊光幾乎沒有可以衰減的地方。', ja: 'ウエストが細く、ショートライティングは落ちる余地がほとんどありません。' },
  'cast.sports-female-01': { zh: '泳裝、運動型', ja: '水着・アスリート' },
  'cast.note.sports-female-01': { zh: '幾乎沒有衣服,全靠光在描述形體。練人體佈光就用這個。', ja: '衣服がほとんどなく、光だけが形を語ります。ボディライティングの練習に。' },
  'cast.medical-female-01': { zh: '醫護服', ja: 'スクラブ' },
  'cast.note.medical-female-01': { zh: '從領口白到鞋子。全場最亮的東西,也是最先過曝的。', ja: '襟から靴まで白。部屋で最も明るく、最初に飛びます。' },
  'cast.female-adult-10': { zh: '長罩袍', ja: 'アバヤ' },
  'cast.note.female-adult-10': { zh: '從肩到地一整塊暗色。只有臉會把主光反回來,曝光要由一個手掌大的區域決定。', ja: '肩から床まで一続きの暗色。光を返すのは顔だけで、露出は手のひら大の面積で決まります。' },
  'cast.male-adult-15': { zh: '白袍', ja: 'トーブ' },
  'cast.note.male-adult-15': { zh: '素白及地,沒有接縫可以斷開。整面高光——主光要打柔,不然褶子全沒了。', ja: '真っ白で床まで、切れ目がありません。ハイライトの壁。主光を柔らかく、でないと襞が消えます。' },
  'cast.male-adult-19': { zh: '白袍與頭巾', ja: 'トーブとケフィエ' },
  'cast.note.male-adult-19': { zh: '頭巾在額頭上壓出一道硬邊,把影子丟進眼窩。要從低處補,否則眼睛沒了。', ja: '頭布が額に硬い稜線を作り、目もとに影を落とします。低い位置から補助光を。' },
  'cast.business-female': { zh: '商務', ja: 'ビジネス' },
  'cast.note.business-female': { zh: '深色西裝會吃掉主光,補光要拉起來才留得住肩線。', ja: 'ダークスーツが主光を飲み込みます。肩を残すには補助光を上げて。' },
  'cast.female-child-01': { zh: '兒童', ja: '子ども' },
  'cast.note.female-child-01': { zh: '小孩比燈架預期的矮一個頭。主光要降下來。', ja: '子どもはライトスタンドの想定より頭ひとつ低い。主光を下げて。' },
  'cast.male': { zh: '日常', ja: '普段着' },
  'cast.note.male': { zh: '基準體型。中間調針織衫,是全場最好抓曝光的東西。', ja: '基準体型。ミッドトーンのニットで、露出を合わせるのが最も簡単。' },
  'cast.male-adult-04': { zh: '連帽衫、厚實', ja: 'パーカー・がっしり' },
  'cast.note.male-adult-04': { zh: '肩比腰窄,帽子會吃掉眼窩。從低處補光。', ja: '肩がウエストより狭く、フードが目もとを飲みます。低い位置から補助光を。' },
  'cast.male-adult-05': { zh: '工作外套、年長', ja: 'ワークジャケット・年配' },
  'cast.note.male-adult-05': { zh: '全場最壯的體型,加上一張有年紀的臉——硬光會把質感全找出來。', ja: 'キャスト最大の体格と年齢のある顔。硬い光は質感を余さず拾います。' },
  'cast.sports-male-01': { zh: '泳褲、運動型', ja: '水着・アスリート' },
  'cast.note.sports-male-01': { zh: '赤膊,寬肩窄腰。輪廓光有邊可以落。', ja: '上半身裸で肩幅広く腰は細い。リムライトが乗る稜線があります。' },
  'cast.male-adult-21': { zh: '白袍與花紋頭巾', ja: 'トーブと柄のケフィエ' },
  'cast.note.male-adult-21': { zh: '另一條頭巾,不同織紋、底下也是不同的臉。花紋細到會產生摩爾紋,拍之前先用全解析度看一次。', ja: 'もう一枚の頭布。織りも下の顔も違います。柄が細かくモアレが出るため、撮る前に等倍で確認を。' },
  'cast.business-male': { zh: '商務', ja: 'ビジネス' },
  'cast.note.business-male': { zh: '黑西裝白襯衫——全場最大的亮度範圍,都在同一格畫面裡。', ja: '黒スーツに白シャツ。キャスト最大の輝度差が一枚に収まります。' },
  'cast.male-child-02': { zh: '兒童', ja: '子ども' },
  'cast.note.male-child-02': { zh: '兒童身高加上較深的膚色。注意主光要越過他的頭頂。', ja: '子どもの背丈と濃い肌。主光が頭を越えるか確認を。' },
  // Captured performance
  'pose.captured-relaxed': { zh: '自然站姿', ja: '自然な立ち' },
  'pose.captured-hands-hips': { zh: '雙手叉腰', ja: '腰に手' },
  'pose.captured-touch-face': { zh: '手撫臉頰', ja: '頬に手' },
  'pose.captured-chin-rest': { zh: '托腮沉思', ja: '頬杖' },
  'pose.captured-open-palms': { zh: '攤手說明', ja: '両手を開く' },
  'pose.captured-seat-upright': { zh: '端坐、手放膝上', ja: '座り・膝に手' },
  'pose.captured-seat-crossed': { zh: '坐姿翹腳', ja: '座り・脚を組む' },
  'pose.captured-seat-chin': { zh: '坐姿托腮', ja: '座り・頬杖' },
  'pose.note.captured-relaxed': { zh: '重心偏在一腳，兩肩不平。想要「一個人」而不是「一個姿勢」時用這個。', ja: '片脚に重心、肩は非対称。ポーズではなく人を写したいときに。' },
  'pose.note.captured-hands-hips': { zh: '手肘在背景上開出兩個三角形，注意那裡露出什麼。', ja: '肘が背景に三角形をふたつ作ります。その中に何が写るか注意。' },
  'pose.note.captured-touch-face': { zh: '手會搶走打在臉上的光，下顎線會出現反射。', ja: '手が顔への光を奪い、顎に反射が出ます。' },
  'pose.note.captured-chin-rest': { zh: '手肘有支撐，指節頂著下巴，前臂會橫過頸部陰影。', ja: '肘を支え、指の関節を顎に。前腕が首の影を横切ります。' },
  'pose.note.captured-open-palms': { zh: '說話到一半雙手攤開，掌心朝主光，會最先過曝。', ja: '話の途中で両手を開いた形。掌が主光に向き最初に飛びます。' },
  'pose.note.captured-seat-upright': { zh: '端正坐好。主光要放低，否則只會照到頭頂。', ja: 'きちんと座った姿勢。主光を下げないと頭頂だけが照らされます。' },
  'pose.note.captured-seat-crossed': { zh: '膝蓋朝前，離鏡頭最近的是褲管。', ja: '膝が前に出て、レンズに最も近いのはズボンの裾です。' },
  'pose.note.captured-seat-chin': { zh: '單手撐著，頭往手的方向偏，補光從另一側打。', ja: '片手で支え頭をそちらへ傾けた形。反対側から補助光を。' },
  ...
  // Pose guidance
  'pose.note.neutral': { zh: '正面站好，適合當作比較所有光比的基準。', ja: '正面向き。すべての光量比を比較する基準です。' },
  'pose.note.contrapposto': { zh: '重心落在單腳，髖線轉折能讓主光更清楚地塑造腰身。', ja: '片足重心。腰の傾きでキーライトが体のラインを描きます。' },
  'pose.note.hands-on-hips': { zh: '手肘形成三角輪廓，注意手臂是否遮住胸廓。', ja: '肘が三角形を作ります。腕が胸郭の光を遮らないか確認してください。' },
  'pose.note.profile': { zh: '完整側身時，短側光會轉化成明顯的輪廓光。', ja: '完全な横向き。ショートライトがリムライトとして見えます。' },
  'pose.note.three-quarter': { zh: '經典人像角度，適合比較窄面光與寬面光。', ja: '定番の斜め角度。ショート／ブロードライティングの比較に向きます。' },
  'pose.note.arms-crossed': { zh: '前臂會在胸前形成明確陰影邊緣，需要時補一點柔光。', ja: '前腕が胸元に強い影を作ります。必要なら柔らかいフィルを加えます。' },
  'pose.note.hands-pockets': { zh: '肩膀放鬆、手臂靠近身體，輪廓簡潔自然。', ja: '肩を落とし腕を体に寄せた、すっきり自然なシルエットです。' },
  'pose.note.lean-back': { zh: '胸口朝向較高的主光，抬起下顎可減少頸部陰影。', ja: '胸が高いキーライトへ開き、あごと首の影が分離します。' },
  'pose.note.walking': { zh: '自然跨步拉開雙腿，適合測試全身條形光的覆蓋範圍。', ja: '自然な歩幅で脚を分け、全身用ストリップライトの範囲を確認できます。' },
  'pose.note.seated-upright': { zh: '坐直後臉部高度下降，主光也要跟著降低，避免只照亮頭頂。', ja: '着座で顔が低くなるため、頭頂だけを照らさないようキーライトも下げます。' },
  'pose.note.seated-lean': { zh: '手肘靠近膝部、身體前傾，臉會更接近主光。', ja: '肘を膝へ寄せて前傾し、顔がキーライトへ近づきます。' },
  'pose.note.seated-crossed': { zh: '下半身形成不對稱輪廓，補光範圍要能完整覆蓋雙腿。', ja: '下半身が非対称になるため、両脚を覆う広いフィルが必要です。' },
  'pose.note.seated-backward': { zh: '雙臂落在椅背上，適合從後側加入一道硬質輪廓光。', ja: '椅子の背に腕を置き、後方から硬いリムライトを入れやすい姿勢です。' },
  'pose.note.jump': { zh: '全身離地的瞬間，建議用短閃光持續時間凝結動作。', ja: '全身が床を離れる瞬間。短い閃光時間で動きを止めます。' },
  'pose.note.reach': { zh: '手臂完全向上伸展，確認柔光箱頂端仍能覆蓋手掌。', ja: '腕を上へ伸ばし、ソフトボックスの光が手先まで届くか確認します。' },
  'pose.note.twist': { zh: '胸廓與髖部反向扭轉，會明顯改變胸口受光面。', ja: '胸郭と腰を逆方向へひねり、胸の受光面を大きく変えます。' },
  'pose.note.crouch': { zh: '降低身體重心，燈架高度也應配合下降。', ja: '重心を低くする姿勢。ライトスタンドも合わせて下げます。' },
  'pose.note.beauty-front': { zh: '正面、下顎微微向前，適合蝴蝶光與美妝測試。', ja: '正面であごを少し前へ。バタフライライトやビューティー撮影向けです。' },
  'pose.note.beauty-hands-face': { zh: '雙手進入臉部光區，手掌反射可能會提亮下顎。', ja: '手が顔の光へ入り、反射光であごが明るくなる場合があります。' },
  'pose.note.over-shoulder': { zh: '身體轉開、臉轉回鏡頭，肩膀會形成主要陰影邊界。', ja: '体を背け顔を戻し、肩が主な影の境界になります。' },
  'pose.note.editorial': { zh: '刻意的不對稱與折線輪廓，能讓硬光看起來更有設計感。', ja: '意図的な非対称と角度で、硬い光をデザインとして見せます。' },
  'pose.note.chin-down': { zh: '下顎壓低、視線抬高，不抬頭也能保留眼神光。', ja: 'あごを引き視線を上げ、顔を上げずにキャッチライトを残します。' },
  'pose.note.laughing': { zh: '自然大笑時眼睛會收窄，注意下眼瞼仍保有眼神光。', ja: '自然な笑いで目が細くなるため、下まぶたのキャッチライトを確認します。' },
  'pose.note.presenting': { zh: '手掌向側邊攤開，可將商品安排在掌心上方。', ja: '手のひらを横へ開き、その上に商品を配置できます。' },
  'pose.note.holding': { zh: '雙手在身前持物，亮面商品適合搭配大型柔光。', ja: '両手で正面に商品を持つ姿勢。反射物には大きな柔らかい光が適します。' },
  'pose.note.thinking': { zh: '前臂橫過頸部，必要時從低角度補光以保留下顎線。', ja: '前腕が首を横切るため、低い位置からフィルを入れて輪郭を残します。' },
  'pose.note.greeting': { zh: '抬高的手掌容易成為畫面最亮處，可用遮光板控制。', ja: '上げた手が画面で最も明るくなりやすいため、フラッグで調整します。' },
  // Hand poses
  ...
  // Lighting setups
  'setup.rembrandt': { zh: '立體戲劇人像', ja: '立体的なドラマポートレート' },
  'setup.loop': { zh: '自然日常人像', ja: '自然な日常ポートレート' },
  'setup.butterfly': { zh: '高顴骨美容光', ja: '頬骨を際立てるビューティー' },
  'setup.clamshell': { zh: '柔和美容光', ja: '柔らかなビューティーライト' },
  'setup.split': { zh: '強烈半臉陰影', ja: '力強い半顔シャドウ' },
  'setup.noir': { zh: '黑色電影輪廓', ja: 'ノワールの輪郭ポートレート' },
  'setup.rim-pair': { zh: '雙側輪廓剪影', ja: 'グラフィックなリムシルエット' },
  'setup.high-key': { zh: '明亮純白商攝', ja: '明るい白背景コマーシャル' },
  'setup.low-key': { zh: '深邃聚光肖像', ja: '深いスポットポートレート' },
  'setup.three-point': { zh: '清晰訪談光', ja: '明快なインタビュー照明' },
  'setup.window-light': { zh: '自然窗邊柔光', ja: '自然な窓辺の柔光' },
  'setup.gel-duo': { zh: '青橙電影對比', ja: 'ティール＆オレンジの映画対比' },
  'setup.product-tent': { zh: '均勻精品商品光', ja: '均一な高級商品ライト' },
  'setup.short-broad': { zh: '顯瘦短光人像', ja: '顔を細く見せるショートライト' },
  'setup.fashion-hard': { zh: '銳利時尚硬光', ja: 'シャープなファッション硬光' },
  // Lighting setup descriptions
  'setup.rembrandt.summary': { zh: '主燈位於側前方 45° 並抬高，在遠側臉頰留下三角亮面。', ja: 'キーを斜め 45° かつ高めに置き、反対側の頬に光の三角形を作ります。' },
  'setup.rembrandt.note': { zh: '主燈水平與垂直各約 45°，讓鼻影向下接到臉頰陰影，並在遠側眼睛下方保留一塊三角亮面。燈再往側面移，三角光會閉合；再升高，鼻影就會落到嘴唇。', ja: 'キーを水平・垂直とも約 45° に置き、鼻の影を頬の影につなげ、反対側の目の下に三角形の光を残します。横へ広げすぎると三角形が閉じ、高くしすぎると影が唇へ落ちます。' },
  'setup.loop.summary': { zh: '日常人像最實用的主光；鼻影形成短小環形，不與臉頰陰影相接。', ja: '日常のポートレートに使いやすいキー。鼻の影は短いループになり、頬の影とはつながりません。' },
  'setup.loop.note': { zh: '主燈水平與垂直各約 35°。鼻影在臉頰形成短小弧形，但不碰到臉頰陰影；這是容錯率最高的光型，因此常作為大頭照的預設燈法。', ja: 'キーを水平・垂直とも約 35° に置きます。鼻の影は頬に短い弧を描きますが、頬の影には触れません。最も失敗しにくいため、ヘッドショットの定番です。' },
  'setup.butterfly.summary': { zh: '主燈位於鏡頭正上方，在鼻下形成蝴蝶形陰影。', ja: 'キーをレンズの真上に置き、鼻の下に蝶形の影を作ります。' },
  'setup.butterfly.note': { zh: '主燈沿鏡頭軸線抬高，下巴下方加反光板補亮眼窩。對稱感是關鍵：能突出顴骨，也會放大臉部左右不對稱。', ja: 'キーをレンズ軸上の高い位置に置き、顎下のレフで目元を起こします。左右対称が要点で、頬骨を美しく見せる一方、顔の非対称も目立ちます。' },
  'setup.clamshell.summary': { zh: '兩盞燈沿鏡頭軸線上下排列，是標準美妝光。', ja: '2 灯をレンズ軸上に上下配置する、定番のビューティーライトです。' },
  'setup.clamshell.note': { zh: '大型光源置於上方，第二盞置於下方，兩者都在鏡頭軸線上，人物位於中間。下方光會填平上方光造成的陰影，很適合皮膚與彩妝拍攝，但不適合需要強烈性格的肖像。', ja: '大きな光源を上、もう 1 灯を下に置き、どちらもレンズ軸にそろえて被写体を間に入れます。上の光が作る影を下の光が埋めるため、肌やメイクには最適ですが、陰影を生かす人物写真には向きません。' },
  'setup.split.summary': { zh: '主燈位於側面 90°，半邊臉亮、半邊臉暗。', ja: 'キーを真横 90° に置き、顔の半分を光、半分を影にします。' },
  'setup.split.note': { zh: '主燈與臉部同高並放在正側方，陰影分界會沿鼻樑中央落下。這種光型幾乎沒有容錯，適合輪廓立體的臉，也最容易暴露結構不足。', ja: 'キーを顔と同じ高さの真横に置くと、鼻筋の中央に影の境界が走ります。非常にシビアな光で、骨格のはっきりした顔を引き立てる一方、立体感の弱さも露わにします。' },
  'setup.noir.summary': { zh: '高側位硬主光，加上一盞硬質逆光。', ja: '高い側面からの硬いキーに、硬いバックライトを加えます。' },
  'setup.noir.note': { zh: '裸反光罩製造銳利陰影，不加補光，再以束光筒逆光把肩線從黑色背景中分離。沒有補光正是這套燈法的核心；一旦柔化，就失去黑色電影感。', ja: 'ベアリフレクターで硬い影を作り、フィルは入れず、スヌートの逆光で肩を黒背景から分離します。フィルがないこと自体がこのセットの要点で、柔らかくするとノワールらしさが失われます。' },
  'setup.rim-pair.summary': { zh: '兩支條形光置於後方，勾出雙肩輪廓，完全不設主光。', ja: '後方の 2 本のストリップで両肩を縁取り、キーは使いません。' },
  'setup.rim-pair.note': { zh: '兩盞燈放在人物後方約 135° 並向前照。臉部保持昏暗，讓外輪廓成為主角；這是在黑色背景上快速做出清楚剪影的方法。', ja: '2 灯を被写体の後方約 135° に置き、前方へ向けます。顔は暗く保ち、輪郭だけで見せるため、黒背景でシルエットを素早く際立たせられます。' },
  'setup.high-key.summary': { zh: '正面平光，加兩盞背景燈把白紙打到純白。', ja: '正面のフラットなキーと背景用 2 灯で、白紙を真っ白に飛ばします。' },
  'setup.high-key.note': { zh: '背景燈比主燈高約 2⅓ 級，足以讓背景過曝成紙白，又不至於反射回人物。必須加遮光板控制，否則包覆光會吃掉畫面對比。', ja: '背景灯はキーより約 2⅓ 段明るくし、被写体へ回り込ませずに背景だけを紙の白まで飛ばします。フラッグで遮らないと、回り込みがコントラストを奪います。' },
  'setup.low-key.summary': { zh: '只用一盞加蜂巢的光源，其餘方向全部遮黑。', ja: 'グリッド付きの 1 灯だけを使い、それ以外の光はすべて遮ります。' },
  'setup.low-key.note': { zh: '小型光源裝上 20° 蜂巢並靠近人物，製造快速明暗衰減。真正控制畫面的是蜂巢：它阻止光線灑到背景，讓黑色維持純黑。', ja: '小型光源に 20° グリッドを付けて被写体へ近づけ、急な光量落ちを作ります。要となるのはグリッドで、背景への漏れを防ぎ、黒を黒のまま保ちます。' },
  'setup.three-point.summary': { zh: '主光、補光與逆光，是訪談拍攝的標準配置。', ja: 'キー、フィル、バックライトを使う、インタビューの標準構成です。' },
  'setup.three-point.note': { zh: '主光置於鏡頭左側約 40°，補光放在對側並降至一半亮度；逆光位於主光側的高後方，讓輪廓落在陰影最深的位置。這套配置通常用於影片，因此採用常亮燈。', ja: 'キーをカメラ左約 40°、フィルを反対側に半分の強さで置きます。バックライトはキー側の高い後方から、最も暗い側に縁取りを作ります。動画でよく使うため、定常光の構成です。' },
  'setup.window-light.summary': { zh: '一盞大型柔光從 60° 側面照入，對側反射補光，不再加燈。', ja: '60° 側方から大きな柔らかい光を入れ、反対側をバウンスで補います。' },
  'setup.window-light.note': { zh: '將約 2 公尺的大型光源直立，並用擦邊方式讓靠近人物的邊緣、而非光源中心對準臉部。正是這種擦邊控制，讓光線像真實窗光般自然衰減，而不是大柔光箱的平坦效果。', ja: '約 2 m の光源を縦に立て、中心ではなく被写体に近い縁を顔へ向けてフェザーします。この外し方が、大型ソフトボックスの平坦さではなく、本物の窓光らしい減衰を生みます。' },
  'setup.gel-duo.summary': { zh: '一側暖色主光，另一側冷色輪廓光。', ja: '片側を暖色のキー、反対側を寒色のリムライトにします。' },
  'setup.gel-duo.note': { zh: '在兩側使用互補色濾片，不靠背景燈也能分離人物。要注意濾片損耗：藍綠色一側在離開燈頭前就會損失近兩級光，因此需要功率較大的燈具。', ja: '左右に補色のジェルを使えば、背景灯なしでも被写体を分離できます。ただし青緑側はジェルを通るだけで約 2 段失うため、出力の大きい灯体が必要です。' },
  'setup.product-tent.summary': { zh: '一盞超大型頂光，左右各放白色反光板。', ja: '非常に大きなトップライト 1 灯と、左右の白カードを使います。' },
  'setup.product-tent.note': { zh: '光源必須比商品更大，否則高光漸層會在邊緣突然中斷。左右白卡提供足夠回光填亮側面，又不會增加第二道高光。', ja: '光源は商品より大きくないと、ハイライトのグラデーションが端で途切れます。左右の白カードで側面を十分に起こしつつ、余分なハイライトは増やしません。' },
  'setup.short-broad.summary': { zh: '主燈放在轉臉後的遠側，可收窄下顎與臉型。', ja: '振り向いた顔の遠い側にキーを置き、顎と顔幅を細く見せます。' },
  'setup.short-broad.note': { zh: '人物轉頭後，把主燈放在背向鏡頭的一側，讓靠近鏡頭的臉頰落入陰影，視覺上會縮窄臉型。相反的寬面光會放大臉，因此多數人像通常優先使用短光位。', ja: '顔を振ったら、カメラから遠い側にキーを置きます。手前の頬が影に入り、顔が細く見えます。逆のブロードライトは顔を広く見せるため、多くの人物ではショートライトが基本です。' },
  'setup.fashion-hard.summary': { zh: '單盞裸燈置於正面高位，形成銳利陰影與飽和色彩。', ja: '正面高めのベアライト 1 灯で、鋭い影と鮮やかな色を作ります。' },
  'setup.fashion-hard.note': { zh: '使用深口拋物線罩或裸反光罩，沿鏡頭軸線抬高。銳利影緣就是風格本身：不補光、不擴散，並讓背景靠近人物，把投影直接納入畫面。', ja: '深型パラボラまたはベアリフレクターをレンズ軸上の高い位置に置きます。硬い影の縁そのものが表現なので、フィルも拡散も使わず、背景を近づけて落ち影まで画面に取り込みます。' },
  // Backdrops
 ...
 */
export function translateCatalog(locale: Locale, id: string, fallback: string) {
...
export function useCatalogT() {
  const locale = useLocaleStore((state) => state.locale)
  return (id: string, fallback: string) => translateCatalog(locale, id, fallback)
}
