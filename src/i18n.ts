...
const DICT = {
  ...
  'mobile.subject.hint': { en: 'The essentials only: silhouette, height, age, pose and clothing.', zh: '只保留影響構圖與打光的重要設定：骨架、身高、年齡、體態、動作與服裝。', ja: '構図と光に重要な骨格・身長・年齢・体型・ポーズ・衣装だけを表示します。' },
