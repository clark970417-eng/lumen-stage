...
export const POSE_LIBRARY: PoseEntry[] = [
  ...
  { id: 'arms-crossed', category: 'standing', label: 'Arms crossed', note: 'Forearms build a hard edge across the chest — fill it or lose it.', pose: p({ leftArm: -2.9, rightArm: 1.7, leftArmForward: 8.7, rightArmForward: 17.4, leftArmTwist: 62.2, rightArmTwist: -56.3, leftElbow: 119.6, rightElbow: -105.2, leftForearmTwist: -55, rightForearmTwist: 55, leftWrist: 6, rightWrist: -6, leftHand: 'grip', rightHand: 'grip', chestLift: 27 }) },
