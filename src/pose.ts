...
export const POSE_LIBRARY: PoseEntry[] = [
  ...
  { id: 'arms-crossed', category: 'standing', label: 'Arms crossed', note: 'Forearms build a hard edge across the chest — fill it or lose it.', pose: p({ leftArm: -34, rightArm: 34, leftArmForward: 26, rightArmForward: 22, leftArmTwist: 0, rightArmTwist: 0, leftElbow: 96, rightElbow: -92, leftForearmTwist: -42, rightForearmTwist: 42, leftWrist: -5, rightWrist: 5, leftHand: 'relaxed', rightHand: 'relaxed', chestLift: 27 }) },
