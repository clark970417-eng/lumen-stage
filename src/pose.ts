...
export const POSE_LIBRARY: PoseEntry[] = [
  ...
  { id: 'hands-on-hips', category: 'standing', label: 'Hands on hips', note: 'Triangles at the elbows. Watch the arms shadowing the ribcage.', pose: p({ leftArm: 3, rightArm: -3, leftArmForward: -31, rightArmForward: -31, leftArmTwist: 3, rightArmTwist: -3, leftElbow: 80, rightElbow: -80, leftForearmTwist: -25, rightForearmTwist: 25, leftWrist: 7, rightWrist: -7, leftHand: 'grip', rightHand: 'grip', stanceWidth: 0.34, chestLift: 36 }) },
  ...
  { id: 'arms-crossed', category: 'standing', label: 'Arms crossed', note: 'Forearms build a hard edge across the chest — fill it or lose it.', pose: p({ leftArm: 40, rightArm: -37, leftArmForward: 8, rightArmForward: 1, leftArmTwist: 31, rightArmTwist: -31, leftElbow: 98, rightElbow: -94, leftForearmTwist: -42, rightForearmTwist: 42, leftWrist: -5, rightWrist: 5, leftHand: 'relaxed', rightHand: 'relaxed', chestLift: 27 }) },
  { id: 'hands-pockets', category: 'standing', label: 'Hands in pockets', note: 'Relaxed shoulders, arms tight to the body. Clean silhouette.', pose: p({ leftArm: 5, rightArm: -5, leftElbow: 18, rightElbow: -17, leftArmForward: -1, rightArmForward: 0, leftForearmTwist: -10, rightForearmTwist: 10, leftWrist: 5, rightWrist: 5, leftHand: 'pocket', rightHand: 'pocket', leftShoulder: -5, rightShoulder: -5, weightShift: 0.26, hipShift: 0.035, chestLift: 21 }) },
  ...
  { id: 'beauty-hands-face', category: 'beauty', label: 'Hands to face', note: 'Hands enter the light — expect a bounce onto the jaw.', pose: p({ leftArm: 36, rightArm: 16, leftArmForward: 99, rightArmForward: 8, leftArmTwist: 1, leftElbow: 136, rightElbow: -24, leftForearmTwist: -18, rightForearmTwist: 16, leftWrist: -10, rightWrist: 6, leftHand: 'open', rightHand: 'relaxed', headTilt: -4, headRoll: 6, neckExtend: 5, smile: 14 }) },
  ...
  { id: 'thinking', category: 'commercial', label: 'Hand to chin', note: 'The forearm cuts across the neck. Fill from below or lose the jaw.', pose: p({ rightArm: -40, rightArmForward: 28, rightArmTwist: 0, rightElbow: -92, rightForearmTwist: 32, rightWrist: 8, rightHand: 'relaxed', leftArm: -18, leftArmForward: 20, leftElbow: 60, leftForearmTwist: -12, leftHand: 'grip', headTilt: -3, headYaw: -10, browRaise: -7, chestLift: 27 }) },
